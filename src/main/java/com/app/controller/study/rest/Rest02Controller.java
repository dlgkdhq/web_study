...
public class Rest02Controller { // 내부 메소드가 모두 RestAPI 형식, text를 리턴하는 방식으로 작동
	...
	public String rest06() {
		...
		/*
		 * 
		 * //User abc, abc123, abcname, CUS 1. 단순 텍스트로 반환 return
		 * "abc,abc123,abcname,CUS"; return "abc|abc123|abcname|CUS";
		 * 
		 * 2. JSON 포맷으로 반환 데이터 전달용 -> 데이터 표현하는 규칙 -> JSON { "id" : "abc", "pw" :
		 * "abc123", "name" : "abcname", "userType" : "CUS" }
		 */

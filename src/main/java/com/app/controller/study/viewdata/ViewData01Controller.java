...
public class ViewData01Controller {
	...
	public String viewData1(HttpServletRequest request) {
		...
		//request.setAttribute(key, value); 	request에 값 저장
	...
	public String viewData2(Model model) {	//model : 화면에 넘길 데이터 
	...
	public ModelAndView viewData3() {
		...
		mav.setViewName("viewData/viewData1");	//뷰이름 연결
	...
	@GetMapping("/viewData7")				//매개변수 전달하는 객체들
